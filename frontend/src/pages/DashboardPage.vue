  ...
  <div class="p-8 max-w-7xl mx-auto">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center">
        ...
        <div>
          <p class="text-sm text-gray-500 font-medium uppercase tracking-wider">Transactions</p>
          <p class="text-3xl font-bold text-gray-900">{{ dashboardStore.stats.totalTransactions }}</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center">
        ...
        <div>
          ...
          <p class="text-3xl font-bold text-gray-900">Rp {{ dashboardStore.stats.totalRevenue.toLocaleString('id-ID') }}</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center">
        ...
        <div>
          ...
          <p class="text-3xl font-bold text-gray-900">{{ dashboardStore.stats.totalProducts }}</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center">
        ...
        <div>
          ...
          <p class="text-3xl font-bold text-gray-900">{{ dashboardStore.stats.totalUsers }}</p>
        </div>
      </div>
